...
//  商品類別
  ...
  val MAM_ChangeNo:        String?=null,       /*變價單號*/
  val PLU_Disc:            String?=null,       /*是否可折扣(Y/N)*/
  val MMP_BegDate:         LocalDateTime?=null,       /*開始日期*/
  val MMP_EndDate:         LocalDateTime?=null,       /*結束日期*/
  val MAM_Quart:           Int?=null,       /*會員贈扣點數*/
  val MAM_TotQuart:        Int?=null,       /*總會員贈扣點數*/
  val MAM_AddPrc:          Int?=null,       /*符合促銷條件後, 再加N元*/
  val MAM_AddQty:          Int?=null,       /*可買M個額外商品*/
  val MAM_AddPLU_No:       Int?=null,       /*額外商品編號*/
